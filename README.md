...
### Modules
All steps are modularized in the ``[src/](https://github.com/apoorvabr314/FinalProject_GLY4930_ABR/tree/main/src)`` directory making it easy to use and resue individual steps and swap in original data.
